...
export const ReceiptPanel = () => {
  const { step, results } = useWizardStore();
  ...
  useEffect(() => {
    if (containerRef.current) {
      ...
      }, 150); // slight delay to allow layout to adjust
    }
  }, [step, results]);

  return (
    <div ref={containerRef} id="receipt-panel-capture" className="w-full md:w-1/2 p-6 md:p-16 bg-neutral-900 relative md:overflow-y-auto flex flex-col scroll-smooth">
